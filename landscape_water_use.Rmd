...
set.seed(777)
sb_pop <- DeclareDesign::declare_population(
    households = add_level(N=40000, 
                           main=sample(c(rep(0,40000*.4),rep(1,40000*.6))), 
                           satisfied=correlate(given = main, 
                                               rho = 0.4,
                                               draw_binary, 
                                               prob = 0.3)
))
...
sam.n <- 250 #attempted sample size store <- rep(NA, sims)
